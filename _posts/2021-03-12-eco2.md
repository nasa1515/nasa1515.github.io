...
**모든 프로젝트를 다루지는 않고**  
**앞으로 사용하게 될 것 같은 프로젝트 위주로 정리했습니다.**    
...
### **Yarn (Yet Another Resource Negotiator)** <a name="a2"></a>
...
**위에서 Yarn의 기초 배경을 깔고, YARN 클러스터에 job 을 요청한 경우 어떠한 방식으로 실행이 되는지 정리해보자**  
...
* #### **4. 모든 task가 종료되면 AM도 종료되고 클러스터에 할당된 컨테이너의 자원도 모두 de-allocated 된다.**  
