...
* **LoadBalancer는 공용,내부 IP를 설정해서 외부와 내부의 LB로 나눠서 설정 할 수 있습니다.**  
...
* **생성이 완료된 LB의 Configure Tab에서 기본설정의 Back-end PooL을 생성합니다.**
