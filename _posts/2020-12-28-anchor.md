...
**정말 간단히 설명해서 Docker Image의 취약점을 스캔하는 스캐너라고 생각하면 된다.**
...
**Anchore는 비교적 쉽게 구현했던 오픈소스인데 그나마 조금 막혔던 부분이  
Anchore는 기본적으로 파이프라인의 성공/실패 여부에 따라 Build를 멈추거나 무시하도록 설정 할 수 있게 되어있는데**  
**이 부분을 모르고 있었습니다.  
