...
- [Bot 생성](#a2)
    - [FrameWork Bot 생성 with VSCODE](#a3)
    - [Azure Bot Channels 생성](#a4)
    - [Bot Python Code 수정](#a5)
    - [Azure Bot Channels 생성](#a4)
--- 
...
### **1-1 FrameWork Bot 생성 with VSCODE** <a name="a3"></a>
...
### **이제 Bot Message를 주고 받을 Channels을 생성합니다.** <a name="a4"></a>
...
### **자 이제 기본적인 환경세팅은 끝났습니다.**  <a name="a5"></a> 
...
#### **Python은 Flask기반의 Code라서 Azure에서는 HTTP GATEWAY ERROR가 발생합니다.**  
#### **Node.js, C#과는 다르게 APP을 실행하는 구문을 바꿔줘야 합니다.**
#### **아래처럼 init_func의 실행 구문을 APP 변수에 넣어준 뒤 실행해야 합니다.**  
