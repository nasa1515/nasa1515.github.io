...
* #### **Hadoop 시작** 
    ...
    ```
    [hadoop@hadoop-master home]$ start-all.sh
    WARNING: Attempting to start all Apache Hadoop daemons as hadoop in 10 seconds.
    WARNING: This is not a recommended production deployment configuration.
    WARNING: Use CTRL-C to abort.
    Starting namenodes on [hadoop-master]
    hadoop-master: hadoop@hadoop-master: Permission denied (publickey,gssapi-keyex,gssapi-with-mic,password).
    Starting datanodes
    hadoop-master: hadoop@hadoop-master: Permission denied (publickey,gssapi-keyex,gssapi-with-mic,password).
    hadoop-worker2: ERROR: JAVA_HOME /usr/bin/jvm/java-1.8.0-openjdk-1.8.0.275.b01-1.el8_3.x86_64 does not exist.
    hadoop-worker: ERROR: JAVA_HOME /usr/bin/jvm/java-1.8.0-openjdk-1.8.0.275.b01-1.el8_3.x86_64 does not exist.
    Starting secondary namenodes [hadoop-master]
    hadoop-master: hadoop@hadoop-master: Permission denied (publickey,gssapi-keyex,gssapi-with-mic,password).
    Starting resourcemanager
    ERROR: Unable to write in /usr/local/hadoop/pids. Aborting.
